...
--model_path logs/lp_epoch300_cycle/rnn_size=256-predictor-posterior-prior-rnn_layers=2-1-1-n_past=2-n_future=10-lr=0.0020-g_dim=128-z_dim=64-last_frame_skip=False-beta=0.0001000/model.pth \
--log_dir logs/lp_epoch300_cycle/rnn_size=256-predictor-posterior-prior-rnn_layers=2-1-1-n_past=2-n_future=10-lr=0.0020-g_dim=128-z_dim=64-last_frame_skip=False-beta=0.0001000/
