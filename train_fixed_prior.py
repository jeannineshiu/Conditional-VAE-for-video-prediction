# python train_fixed_prior.py --log_dir ./logs/fp_epoch100_2_cycle --kl_anneal_cyclical
...
def main():
    ...
    if args.model_dir != '':
        ...
        # g_dim = 128, z_dim = 64, condition = 7
        # input_size, output_size, hidden_size , n_layers
        # pθ : take ht-1, zt, and condition as input, dim = 128 + 64 + 7
        #      output gt for putting into the decoder
        frame_predictor = lstm(args.g_dim+args.z_dim+7, args.g_dim, args.rnn_size, args.predictor_rnn_layers, args.batch_size, device)
        # qφ : take the output of encoder (ht) as input, dim = 128. 
        #      output zt, dim = 64
    ...
    if args.model_dir != '':
        ...
        # encoder will output 128 1x1 feature maps
